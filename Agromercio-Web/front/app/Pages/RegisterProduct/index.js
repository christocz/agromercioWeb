...
export default class extends React.Component {
        ...
        this.updloadFile = this.updloadFile.bind(this);
    }
    ...
    updloadFile(event) {
        ...
        formData.append('upload_preset','vgtgfyg9');
            
        axios.post('https://api.cloudinary.com/v1_1/agromercio/upload', formData)
        .then(res => {
            const selectedFile = res.data;
                            ...
                            <div className="card">
                                <div className="card-content">
                                    <form onSubmit={this.addProduct}>
                                        ...
                                        <div className="row">
                                            <input type="file" onChange={this.updloadFile} />
                                        </div>
